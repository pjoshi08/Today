...
//  Today
//
//  Created by Parth Joshi on 12/2/23.
//
...
/// You could also use a where clause to conditionally extend a generic type, like this: extension Array where Element == Reminder.
extension [Reminder] {
